...
public class FXMLController {
    ...
    void stampaDivisione(ActionEvent event) {
    	...
    	if(codins == null || codins.equals("")) {
    		txtRisultato.appendText("Per favore inserisi codice corso");
    		return;
    	}
    	...
    	//Uso comparatore per ordinare una stessa classe in modi diversi, sennò uso l'implemements se la ordino sempre allo stesso modo
